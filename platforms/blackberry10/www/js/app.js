...
if (share && plugins && plugins.socialsharing) {
	...
	$('section.story').addClass('full-height');
	$('footer').remove();
}
...
},{"../util/notify":28,"./getFile":16,"./getFileSystem":20,"./readFile":23}],18:[function(require,module,exports){
...
},{"../util/notify":28}],24:[function(require,module,exports){
module.exports = function (fileentry) {
    return new Promise(function (resolve, reject) {
